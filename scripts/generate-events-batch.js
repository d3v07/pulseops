...
/**
 * Generate synthetic events using batch endpoint for faster loading
 */

const API_URL = process.env.API_URL || 'http://localhost:3001';
const API_KEY = process.env.API_KEY || 'demo_key_change_this';
const TOTAL_EVENTS = parseInt(process.argv[2] || '2000', 10);
const BATCH_SIZE = 100; // Send 100 events per batch
const DELAY_MS = 700; // 700ms delay between batches to stay under rate limit
